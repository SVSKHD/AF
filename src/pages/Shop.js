...
import { Menu, Slider, Checkbox, Radio  , Card} from "antd";
      ...
      <Card>
        <div className="row">
            ...
            <div className="col-md-4">
                <h4 className="HometextDark">Search Filters</h4>
                <hr/>
                <Menu
          ...
          >
            ...
            <div className="col-md-8">
              {loading ? (
                  <h4 className="Common">Loading...</h4>
                ) : (
                  <h4 className="HometextDark">Products</h4>
                )}
               <hr/>
